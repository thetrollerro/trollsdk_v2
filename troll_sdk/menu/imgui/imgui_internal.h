...
namespace ImGui
{
    ...
    IMGUI_API bool           ButtonEx2( const char* first_label , const char* second_label , ImFont* first_font , ImFont* second_font , const ImVec2& size_arg , ImGuiButtonFlags flags );
