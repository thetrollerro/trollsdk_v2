...
void engine_prediction::predict( c_usercmd* cmd ) {
	...
	/* get spread and innacuracy after we updated accuracy penalty */
...
void engine_prediction::update( ) {
	...
	i::prediction->update( i::clientstate->delta_tick, true, i::clientstate->last_command_ack, i::clientstate->last_outgoing_command + i::clientstate->choked( ) );
}
